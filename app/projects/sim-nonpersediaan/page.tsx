...
const projectDetail = {
  ...
  description:
    "SIM BHP adalah platform manajemen persediaan terpadu yang dirancang untuk mengelola stok barang pakai habis non-persediaan di Balai Diklat Industri (BDI) Medan. Aplikasi ini mendigitalisasi seluruh alur pencatatan barang mulai dari penerimaan, pengeluaran, peminjaman, pengembalian, hingga pelaporan stok secara real-time dengan sistem validasi multi-level.",
  webLink: "https://simnonpersediaan.zite.so/", // Contoh Link Web Aplikasi
  ...
  screenshots: [
    "/projects/simbhp-cover.png", // Ganti dengan path screenshot Anda
    "/projects/simbhp/dashboard-admin.png",
    "/projects/simbhp/menu-operator.png",
  ],
  features: [
    "Pencatatan Barang Masuk, Keluar, Penggunaan & Pengembalian",
    "Sistem Validasi Transaksi Multi-Level (Operator → Validator)",
    "Dashboard Monitoring Stok Real-Time & Deteksi Stok Rendah",
    "Cetak Laporan Resmi Persediaan (PDF & Excel) dan Log Aktivitas",
    "Import Transaksi Massal via Excel dengan Auto-Validasi",
    "Manajemen Master Data (User, Barang, Satuan)",
  ],
  documents: [
    ...
    <main className="min-h-screen bg-[#090d16] text-slate-200 selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <section className="mx-auto max-w-7xl px-6 pt-8 pb-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <div
              className={`h-1 w-20 rounded-full bg-gradient-to-r ${projectDetail.color} mb-4`}
            ></div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="mb-8">
            <h2 className="text-2xl font-bold tracking-tight text-white mb-2">
              Lampiran & Dokumen Sistem
            </h2>
            <p className="text-sm text-slate-400">
              Unduh berkas arsitektur diagram, flow rancangan, serta dokumen
              pendukung analisis sistem.
            </p>
          </div>
              ...
              >
                <div className="flex items-center gap-3.5 overflow-hidden">
                  ...
                  <div className="overflow-hidden">
                    <p
                      className="truncate text-sm font-semibold text-slate-200 group-hover/doc:text-blue-400 transition-colors"
                      title={doc.name}
                    >
                      {doc.name}
                    </p>
                ...
                <a
                  href={`/projects/simbhp/${doc.name}`} // Sesuaikan endpoint atau path public folder file Anda
                  download
