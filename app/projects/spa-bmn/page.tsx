...
const projectDetail = {
  ...
  subtitle:
    "Platform Pengecekan dan Pemeliharaan Aset Barang Milik Negara Berbasis Web",
  description:
    "Sistem Pemeliharaan Aset BMN adalah aplikasi web terpadu untuk mengelola seluruh siklus pemeliharaan Barang Milik Negara di Balai Diklat Industri Medan. Aplikasi ini mendigitalisasi alur pengecekan lapangan, persetujuan bertingkat (Admin → Validator → Komitmen → PBJ), hingga pelaporan dan kartu pemeliharaan secara otomatis.",
  webLink: "https://sipasbdi.zite.so/", // Contoh Link Web Aplikasi
  ...
  screenshots: [
    ...
    "/projects/spabmn/admin.png",
    "/projects/spabmn/pengecekan.png",
  ],
  features: [
    "Manajemen Aset BMN dengan Import/Ekspor Excel",
    "Alur Pengecekan Berkala Multi-Peran (6 Tahap)",
    "Laporan & Kartu Pemeliharaan (PDF, Excel, Word)",
    "Jadwal Pemeliharaan dengan Ekspor Kalender (.ics)",
    "Dashboard Real-Time per Peran Pengguna",
    "Manajemen User dengan 6 Role (Admin, Operator, Validator, Komitmen, PBJ, Pegawai)",
  ],
  documents: [
    {
      name: "Manual Book Sistem Pemeliharaan Aset BMN BDI Medan.pdf",
      size: "6.06 MB",
      type: "pdf",
    },
  ],
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {projectDetail.documents.map((doc, idx) => (
              ...
              >
                ...
                <a
                  href={`/projects/spabmn/${doc.name}`} // Sesuaikan endpoint atau path public folder file Anda
                  download
